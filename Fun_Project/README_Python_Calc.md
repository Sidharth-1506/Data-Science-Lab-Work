Project 1: Basic Python Calculator
Description

This project is a simple command-line calculator that performs basic arithmetic operations such as addition, subtraction, multiplication, and division. The objective is to understand user input handling, conditional logic, and basic Python operations.
